...
#airparif <- read.csv("airparif_centre_31_10_2017.csv", sep = ";", stringsAsFactors = FALSE)

airparif <- read.csv("airparif_centre_21_11_2017.csv", sep = ";", stringsAsFactors = FALSE)
```
...
airparif <- airparif[, c(1,8:10,2,4,3,6,5,7)]
str(airparif)
